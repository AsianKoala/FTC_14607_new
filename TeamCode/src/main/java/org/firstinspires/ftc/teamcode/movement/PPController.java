...
public class PPController {
    ...
    public static movementResult goToPosition(double targetX, double targetY, double moveSpeed, double turnSpeed, double prefAngle, double slowDownTurnRadians, double slowDownMovementFromTurnError, double thresh, boolean stop) {
